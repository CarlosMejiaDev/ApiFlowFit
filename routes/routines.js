...
const saveExercisesToDatabase = require('../models/routine');
...
// GET /saveExercises - Guarda los ejercicios de la API en la base de datos
router.get('/saveExercises', async (req, res) => {
  try {
